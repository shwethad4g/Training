...
public class SeniorStaff extends Employee {
    ...
    public void calculateAppraisal() {
        ...
        if ((peerReview >= 4 && selfAppraisal >= 4)&&(peerReview<=5 && selfAppraisal<=5)&& (clientRating>=3&& clientRating<=5)) {
            rate = 10;
       ...
       else if ((peerReview<4&&selfAppraisal<4)||(peerReview>5 && selfAppraisal>5)||(clientRating<3)){
