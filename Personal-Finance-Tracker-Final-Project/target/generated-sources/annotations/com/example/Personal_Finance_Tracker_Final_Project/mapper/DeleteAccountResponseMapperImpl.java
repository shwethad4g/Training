...
@Component
public class DeleteAccountResponseMapperImpl implements DeleteAccountResponseMapper {

    @Override
    public DeleteAccountResponseDTO toDTO(String message) {
        if ( message == null ) {
            return null;
        }
        ...
        deleteAccountResponseDTO.setMessage( message );
