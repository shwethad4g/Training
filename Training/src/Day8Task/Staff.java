...
public class Staff extends Employee {
    ...
    public void calculateAppraisal() {
        ...
        if ((peerReview >= 3 && selfAppraisal >= 3) && (peerReview <= 5 && selfAppraisal <= 5) &&
                (clientRating >= 3 && clientRating <= 5)) {
            rate = 5;
            updatedSalary = (hike = (getSalary() * rate / 100 + getSalary()));
            System.out.println(" congratulations!! here is your updated salary" +
                    " after appraisal for this year:" + " " + updatedSalary);
        }
